...
def make_model(model_name: str):
    ...
    return {
        'tripletnet': LinearNaive(256 * 3, lr=1e-3, num_classes=9, weights=weights),
...
def make_dataloaders(num_workers: int, batch_size: int, finetune: bool = False, model: str = None):
...
def train(cfg):
    ...
    dataloaders = make_dataloaders(
        num_workers=cfg.num_workers, batch_size=cfg.batch_size, finetune=False, model=cfg.model_type
    )
